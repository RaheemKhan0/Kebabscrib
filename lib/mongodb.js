...
// const password = encodeURIComponent("Mongodb123");

//let MONGODB_URI = `mongodb+srv://rabierizwan9:${password}@kebabscrib-menu.kafey.mongodb.net/?retryWrites=true&w=majority&appName=kebabsCrib-menu`;
